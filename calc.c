...
int main()
{
    ...
    printf("Enter 11 for cubicroot\n");
    printf("Enter 12 for log10\n");
...
{
    double b;
    printf("Enter the number you want the Cubic root of : ");
    scanf("%lf",&b);
    double c = cbrt(b);
    printf("The cubic root of %lf is %lf",b,c);
}

void clog10()
{
    double b;
    printf("Enter the number you want the log10 of : ");
    scanf("%lf",&b);
    double res = log10(b);
    printf("The cubic root of %lf is %lf",b,res);
}
